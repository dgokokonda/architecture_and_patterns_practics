...
// Класс News отвечает только за данные, а не за их отображение.
class News {
...
// ===========================
// Во Вью к примеру правильное разделение ответственности:
// Компонент только отображает содержимое
// Отдельный сервис для данных и работы с запросами
// Отдельный composable для логики компонента
